  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	  ...
	  <section class="content-header">
       <h1 class="box-title heading-title " >View Business Unit</h1>
    </section>
      ...
      <div class="row">
          <div class="box-header with-border">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                  <a href="<?= $this->Url->build(['controller' => 'BusinessUnit', 'action' => 'addBusinessUnit']) ?>" class="btn btn-primary" style="margin-left:-7px;">
          ...
          <td><?= h($businessUnit->bu_desc) ?></td>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link(__('Edit'), ['action' => 'editBusinessUnit', $businessUnit->id]) ?>
