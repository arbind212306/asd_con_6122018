  ...
  <div class="content-wrapper">
	...
	<section class="content-header" >
       <h1 class="box-title heading-title " >Manage Industry</h1>
    </section>
      ...
      <div class="row">
          <div class="box-header with-border">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                  <a href="<?= $this->Url->build(['controller' => 'Industry', 'action' => 'addIndustry']) ?>" class="btn btn-primary" style="margin-left: -7px;">
          ...
          <?php foreach ($industry as $industry){ ?>
            <tr>
                <td><?= $industry->id ?></td>
                <td><?= $industry->business_unit->bu_name ?></td>
                <td><?= h($industry->industry_name) ?></td>
                <td><?php  $status= $industry->status ?>
                <?php  if($status == '1') { ?>
                Active
                  <?php } else {?>
                  Deactive
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link(__('Edit'), ['action' => 'editIndustry', $industry->id]) ?>
