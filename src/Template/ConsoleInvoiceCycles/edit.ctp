 ...
 * @var \App\Model\Entity\ConsoleModeOfPayment $consoleInvoiceCycle
 */
?>
...
<!-- Left side column. contains the logo and sidebar -->
    ...
    <section class="content"  style="padding-top:10px;">
      ...
      <?= $this->Form->create($consoleInvoiceCycle) ?>
        <!-- left column -->
       <div class="col-md-12 " >
        <div class="col-md-5 col-xs-12 col-sm-5">
          <!-- general form elements -->
           ...
           <div class="form-group">
                  ...
                  <input type="text" id="name"  name="invoice_cycle_name" class="form-control"  placeholder="" value="<?= $consoleInvoiceCycle->invoice_cycle_name ; ?>">
            ...
            <div class="form-group">
               ...
               <?php //echo $this->Form->control('status',(['name'=>'status','class'=>'form-control','id'=>'status']));?>
                  <select class="form-control" name="status" id="status">
                     <?php $status=$consoleInvoiceCycle->status ;       
                    ?>
                     <?php  if($status == '1') { ?>
...
if($('#name').val()=='')
  {
    ...
    $('#check_name').text('Please enter Console Invoice Cycle  ');
