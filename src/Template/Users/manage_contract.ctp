  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
	 <section class="content-header">
       <h1 class="box-title" style="margin-left: 10px;margin-top: 0px; font-style: bold -13px">Manage Contract</h1>
    </section>
    <section class="content-header">
...
<div class="col-xs-12 margin-top-lg ">
            ...
            <?php foreach ($client_services_details as $client_lists) {?>
              ...
              <tr>
                    <td><?php echo $client_lists->clientmaster['client_name'] .' ' .$client_lists['id'];?></td>
...
<<<<<<< .mine
                        foreach($client_services_details1 as $image_details1){
                            if($client_lists['id'] == $image_details1['client_id']){
                                $imgpath = $image_details1['image'];
                                $path1 = $this->Url->build('/'); 
                                $path = "$path1" . "upload/$imgpath";
                                echo ' '.'<a target="_blank" href="' . $path .'">' .'<i class="fa fa-download"></i>'. '</a>';}
                            }
=======
                        foreach($client_services_details1 as $image_details){
                          if($client_lists['id'] == $image_details['client_id'])
                          {
                              $imgpath = $image_details['image'];
                              $path1 = $this->Url->build('/'); 
                              $path = "$path1" . "upload/$imgpath";
                             echo ' '.'<a target="_blank" href="' . $path .'">' .'<i class="fa fa-download"></i>'. '</a>';}
>>>>>>> .r135
                    ...
                    <td>
                        ...
                        <?php } ?>
                         ...
                         <?php $url_pdf = $this->Url->build(['controller' => 'admin', 'action' => 'generatePdf']); ?>
           
                  <a href="<?php echo $url_pdf?>"style="margin-left: 6px;">
              <i class="fa fa-file-pdf-o" title="Download Invoice"></i></a>
