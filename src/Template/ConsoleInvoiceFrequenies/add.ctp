...
<!-- header section ends here -->
  <div class="content-wrapper">
    ...
    <section class="content-header" >
       <h1 class="box-title heading-title ">Add Console Invoice Frequenies</h1>
    </section>
            ...
            <br> 
			  ...
			  <div class="form-group">
                  <label for="name">Name</label>
                    ...
                    <input type="text" id="name"  name="invoice_frequency_name" class="form-control"  placeholder="">
...
if($('#name').val()=='')
  {
    ...
    $('#check_name').text('Please enter Console Invoice Frequenies ');
