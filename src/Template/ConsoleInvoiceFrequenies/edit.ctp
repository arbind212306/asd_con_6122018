 ...
 * @var \App\Model\Entity\ConsoleModeOfPayment $consoleInvoiceFrequeny
 */
?>
...
<!-- header section ends here -->
  <div class="content-wrapper">
    ...
    <section class="content-header" >
       <h1 class="box-title heading-title ">Edit Console Invoice Cycle</h1>
    </section>
<!-- Left side column. contains the logo and sidebar -->
    ...
    <section class="content"  style="padding-top:10px;">
      ...
      <?= $this->Form->create($consoleInvoiceFrequeny) ?>
        <!-- left column -->
       <div class="col-md-12 " >
        <div class="col-md-5 col-xs-12 col-sm-5">
          <!-- general form elements -->
           ...
           <div class="form-group">
                  ...
                  <input type="text" id="name"  name="invoice_frequency_name" class="form-control"  placeholder="" value="<?= $consoleInvoiceFrequeny->invoice_frequency_name ; ?>">
            ...
            <div class="form-group">
               ...
               <?php //echo $this->Form->control('status',(['name'=>'status','class'=>'form-control','id'=>'status']));?>
                  <select class="form-control" name="status" id="status">
                     <?php $status=$consoleInvoiceFrequeny->status ;       
                    ?>
                     <?php  if($status == '1') { ?>
...
if($('#name').val()=='')
  {
    ...
    $('#check_name').text('Please enter Console Invoice Frequeny  ');
