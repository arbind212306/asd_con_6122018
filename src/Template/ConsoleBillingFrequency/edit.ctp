 ...
 * @var \App\Model\Entity\ConsoleModeOfPayment $consoleBillingFrequency
 */
?>
...
<!-- header section ends here -->
  <div class="content-wrapper">
    ...
    <section class="content-header" >
       <h1 class="box-title heading-title ">Edit Console Billing Frequency</h1>
    </section>
        ...
        <div class="col-md-5 col-xs-12 col-sm-5">
          <!-- general form elements -->
           ...
           <div class="form-group">
                  ...
                  <input type="text" id="name"  name="name" class="form-control"  placeholder="" value="<?= $consoleBillingFrequency->name ; ?>">
            ...
            <div class="form-group">
               ...
               <?php //echo $this->Form->control('status',(['name'=>'status','class'=>'form-control','id'=>'status']));?>
                  <select class="form-control" name="status" id="status">
                     <?php $status=$consoleBillingFrequency->status ;       
                    ?>
                     <?php  if($status == '1') { ?>
...
if($('#name').val()=='')
  {
    ...
    $('#check_name').text('Please enter Console Billing Frequency ');
