 ...
 */
class ConsoleInvoiceCyclesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('console_invoice_cycles');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('invoice_cycle_name')
            ->maxLength('invoice_cycle_name', 30)
            ->allowEmpty('invoice_cycle_name');
